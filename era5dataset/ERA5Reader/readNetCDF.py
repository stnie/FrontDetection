...
def getMeanVarOld(variable):
    mean,var = 0.5,1
    # pseudo-normalize variables 
    if(variable == 't'):
        mean, var = (273.0), 262.4
    elif(variable == 'ept'):
        mean, var = None, None
    elif(variable == 'dewt'):
        mean, var = None, None
    elif(variable == 'dtu' or variable == 'delta_t_udir' or variable == 'delta_t_ldir'):
        mean, var = 0, 0.11
    elif(variable == 'dtv' or variable == 'delta_t_vdir'):
        mean, var = -0.03, 0.23
    elif(variable == 'q'):
        mean, var = 0.004, 1.7e-05 
    elif(variable == 'delta_q_udir' or variable == 'delta_q_ldir'):
        mean, var = -0.0, 9.5e-08
    elif(variable == 'delta_q_vdir'):
        mean, var = 1.57e-06, 1.0e-07
    elif(variable[-4:] == '2pol'):
        mean, var = np.pi/2, 0.64
    elif(variable[-4:] == '2abs'):
        mean, var = 9.24, 38.01
    elif(variable == 'delta_u_udir' or variable == 'delta_u_ldir'):
        mean, var = 2.8e-07, 0.146
    elif(variable == 'delta_u_vdir'):
        mean, var = 0.003, 0.79
    elif(variable == 'delta_v_udir' or variable == 'delta_v_ldir'):
        mean, var = -2.25e-07, 0.208
    elif(variable == 'delta_v_vdir'):
        mean, var = 0.002, 0.4576
    elif(variable == 'u'):
        mean, var = 2.1, 77.09
    elif(variable == 'v'):
        mean, var = 0.04, 46.33
    elif(variable == 'w'):
        mean, var = -9e-05, 0.058
    elif(variable == 'sp'):
        mean, var = 86279.16, 158705324.9
    elif(variable == 'latitude'):
        mean, var = 0.64, 0.09
    return mean, var
